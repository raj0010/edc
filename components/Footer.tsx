      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <h3 className="text-2xl font-bold text-white font-display">EDC Nexus</h3>
            <p className="text-sm text-neutral-500 mt-2">Empowering Student Entrepreneurs since 2010.</p>
          </div>
        ...
        <div className="border-t border-neutral-900 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-neutral-600">
